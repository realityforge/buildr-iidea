...
=== Generate Compiler settins

Generate component elements for "ProjectRootManager", "JavacSettings" and "CompilerConfiguration"
based on compiler.options in the project file. Allow the user to override as appropriate.
